      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-muted-foreground text-sm sm:text-base mb-4 sm:mb-6 leading-relaxed max-w-3xl mx-auto">
              Most organisations fail because they rush into tools without clarity and purpose. IntegroAI applies a simple principle:
            </p>
            <blockquote className="border-l-4 border-accent-warm pl-4 sm:pl-6 py-3 mb-4 sm:mb-6 bg-accent-warm/5 rounded-r-lg text-left max-w-2xl mx-auto">
