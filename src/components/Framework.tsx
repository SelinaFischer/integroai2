  ...
  const steps = [
    {
      ...
      step: "01",
      title: "Discover",
      description: "Understand your current state, surface readiness gaps, and identify where AI can create real business value",
    ...
    },
    {
      ...
      step: "02",
      title: "Design",
      description: "Define priorities, success measures, and guardrails so AI initiatives align with business goals before execution begins",
    ...
    },
    {
      ...
      step: "03",
      title: "Validate",
      description: "Test assumptions through focused pilots to confirm impact, feasibility, and risk before scaling",
      gradient: "from-accent-warm to-amber-400",
    },
    {
      icon: TrendingUp,
      step: "04",
      title: "Deliver",
      description: "Implement validated solutions with structure, oversight, and clear accountability for measurable outcomes",
      gradient: "from-primary to-cyan-600",
    },
    {
      icon: RefreshCw,
      step: "05",
      title: "Iterate",
      description: "Refine and improve as the organisation, data, and operating environment evolve over time",
      gradient: "from-accent-warm to-amber-400",
    },
  ];
