...
const CTA = () => {
  return (
    <section className="py-24 lg:py-32 bg-hero relative overflow-hidden">
      ...
      {/* Animated orbs */}
      <motion.div 
        className="absolute top-0 right-0 w-[500px] h-[500px] bg-accent-warm/20 rounded-full blur-[120px]"
        animate={{ scale: [1, 1.15, 1], opacity: [0.2, 0.25, 0.2] }}
        transition={{ duration: 10, repeat: Infinity, ease: "easeInOut" }}
      />
      <motion.div 
        className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-secondary/15 rounded-full blur-[100px]"
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          >
            <Sparkles className="w-4 h-4 text-accent-warm" aria-hidden="true" />
            <span className="text-white/80 text-sm font-medium">Start Your AI Journey</span>
          </motion.div>
          ...
          <motion.div 
            ...
            className="flex flex-wrap justify-center gap-x-6 gap-y-2 text-white/50 text-sm mt-10"
          >
